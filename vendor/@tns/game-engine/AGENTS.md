...
- Engine helpers (physics, animation, audio, dialogue, save, level, and accessibility) live in sibling subfolders next to `core/`. Each gets its own subfolder and entry file.
